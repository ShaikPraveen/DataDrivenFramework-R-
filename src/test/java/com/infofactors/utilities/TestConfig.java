...
public class TestConfig{
	...
	public static String from = "info.praveen77@gmail.com";
	public static String password = "praveen@1120";
	public static String[] to ={"shaikpraveen323@gmail.com","shaikpraveen323@gmail.com"};
